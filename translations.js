...
const TRANSLATIONS = {
    "en": {
        ...
        "text": {
            ...
            "#skills .skill-card:nth-child(6) p": "Actively learning React, TypeScript, Spring AI, and AI application development.",
    ...
    "zh": {
        ...
        "text": {
            ...
            "#skills .skill-card:nth-child(6) p": "持续学习 React、TypeScript、Spring AI 与 AI 应用工程实践。",
            "#projects > h2": "个人项目",
